        ...
        try {
          ...
          const unsubscribeDebts = onSnapshot(
            ...
            (snapshot) => {
              ...
              setDebts(debtsData);
              console.log('Debts data loaded:', debtsData.length, 'records');
            },
            (err) => {
          ...
          const unsubscribeClients = onSnapshot(
            ...
            (snapshot) => {
              ...
              console.log('Clients data loaded:', clientsData.length, 'records');
            },
            (err) => {
          ...
          const unsubscribeBank = onSnapshot(
            ...
            (snapshot) => {
              ...
              console.log('Bank deposits loaded:', bankData.length, 'records');
            },
            (err) => {
