  ...
  const handlePresetChange = (type) => {
    ...
    switch (type) {
      ...
      case "yesterday":
        newFilter = {
          type,
          startDate: format(subDays(startOfDay(today), 1), "yyyy-MM-dd"),
          endDate: format(subDays(startOfDay(today), 1), "yyyy-MM-dd"),
        };
        break;
      case "yesterdayButOne":
        newFilter = {
          type,
          startDate: format(subDays(startOfDay(today), 2), "yyyy-MM-dd"),
          endDate: format(subDays(startOfDay(today), 2), "yyyy-MM-dd"),
        };
        break;
      case "week":
        newFilter = {
        ...
        <div className="card-content space-y-4">
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            >
              ...
              <option value="yesterdayButOne">Day Before Yesterday</option>
